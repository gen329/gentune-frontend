...
function Home() {
  ...
  return (
    <div className='flex'>
      <h2>Welcome to GenTune - Your Music Library Solution!
...
Whether you're looking for specific songs, want to organize your music, or simply explore different genres, GenTune has got you covered.
Start your musical journey with GenTune and experience the joy of seamless music management and discovery!
Enjoy your tunes! 🎶
</h2>
    </div>
  );
